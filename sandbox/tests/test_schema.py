...
from sandbox.pipeline.container import ConversionTrace, OriginalContainer
from sandbox.pipeline.verbatim import BorderFillDef, StyleDef
...
class TestPipelineVerbatimLayer:
    ...
    def test_with_resources(self):
        from sandbox.pipeline.verbatim import GlobalResources
        vl = VerbatimLayer(
            format="hwp",

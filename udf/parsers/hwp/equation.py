...
_SPECIAL_SYMBOLS: dict[str, str] = {
    ...
    "REAL": r"\mathbb{R}", "NATURAL": r"\mathbb{N}",
    "INTEGER": r"\mathbb{Z}", "RATIONAL": r"\mathbb{Q}",
    "COMPLEX": r"\mathbb{C}",
    "COMPLEMENT": r"\complement",
    "SHARP": r"\sharp", "FLAT": r"\flat",
    "CLUBSUIT": r"\clubsuit", "DIAMONDSUIT": r"\diamondsuit",
    "HEARTSUIT": r"\heartsuit", "SPADESUIT": r"\spadesuit",
}
...
_SET_RELATION: dict[str, str] = {
    ...
    "BOWTIE": r"\bowtie", "LTIMES": r"\ltimes", "RTIMES": r"\rtimes",
    "AMALG": r"\amalg",
}
...
_ARITHMETIC_LOGIC: dict[str, str] = {
    ...
    "BIGTRIANGLEUP": r"\bigtriangleup", "BIGTRIANGLEDOWN": r"\bigtriangledown",
    "DAGGER": r"\dagger", "DDAGGER": r"\ddagger",
    "PM": r"\pm", "MP": r"\mp",
    "SETMINUS": r"\setminus", "BACKSLASH": r"\backslash",
    "WREATH": r"\wr",
    "BOXPLUS": r"\boxplus", "BOXMINUS": r"\boxminus",
    "BOXTIMES": r"\boxtimes", "BOXDOT": r"\boxdot",
    "CIRCLEDAST": r"\circledast", "CIRCLEDCIRC": r"\circledcirc",
    "CIRCLEDDASH": r"\circleddash",
}
...
_ARROWS: dict[str, str] = {
    ...
    "LHOOK": r"\hookleftarrow", "RHOOK": r"\hookrightarrow",
    "mapsto": r"\mapsto",
    "vert": "|", "VERT": r"\|",
...
_OTHER_SYMBOLS: dict[str, str] = {
    ...
    "RTANGLE": r"\Box",
    "VDASH": r"\vdash", "DASHV": r"\dashv", "HLEFT": r"\dashv",
    "NVDASH": r"\nvdash", "NMODELS": r"\not\models",
    "BOT": r"\bot", "TOP": r"\top", "MODELS": r"\models",
    "PERP": r"\perp", "MID": r"\mid", "PARALLEL": r"\parallel",
    "NMID": r"\nmid", "NPARALLEL": r"\nparallel",
...
BIG_OP_CMDS: dict[str, str] = {
    ...
    "sum": r"\sum", "SUM": r"\sum",
    "smallsum": r"\sum", "SMALLSUM": r"\sum",
    "prod": r"\prod",
    "smallprod": r"\prod", "SMALLPROD": r"\prod",
